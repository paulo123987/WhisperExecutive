...
# ═══════════════════════════════════════════════════════════════════════════════
#  INICIALIZAR TRANSCRIBER (cacheado por modelo)
# ═══════════════════════════════════════════════════════════════════════════════
@st.cache_resource(show_spinner="🔄 Carregando modelo Whisper...")
def get_transcriber(model_name: str, openai_key: str, groq_key: str):
...
transcriber = get_transcriber(whisper_model, effective_openai, effective_groq)
...
<div class="footer">
  ...
  Modelo: <strong>{whisper_model}</strong> &nbsp;|&nbsp;
